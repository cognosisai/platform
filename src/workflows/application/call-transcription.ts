...
export async function TranscriptToStructuredData( filename: string, transcript: string ): Promise< string >
{
  let result = '{"resolved?": "' + await promptTemplate(
    ...
    {"resolved?": "`, {chunk: transcript}, 20, 500, 1.0, "gpt-3" ) ;
